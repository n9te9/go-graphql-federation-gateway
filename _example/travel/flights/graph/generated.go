...
type ComplexityRoot struct {
	...
	Query struct {
		Flight             func(childComplexity int, number string, departureDate string) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.flight":
		...
		return e.complexity.Query.Flight(childComplexity, args["number"].(string), args["departureDate"].(string)), true
	case "Query._service":
...
func (ec *executionContext) _Query_flight(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Query().Flight(ctx, fc.Args["number"].(string), fc.Args["departureDate"].(string))
		},
		nil,
		ec.marshalOFlight2ᚖgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋflightsᚋgraphᚋmodelᚐFlight,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalNFlight2githubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋflightsᚋgraphᚋmodelᚐFlight(ctx context.Context, sel ast.SelectionSet, v model.Flight) graphql.Marshaler {
	return ec._Flight(ctx, sel, &v)
}

func (ec *executionContext) marshalNFlight2ᚖgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋflightsᚋgraphᚋmodelᚐFlight(ctx context.Context, sel ast.SelectionSet, v *model.Flight) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOFlight2ᚖgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋflightsᚋgraphᚋmodelᚐFlight(ctx context.Context, sel ast.SelectionSet, v *model.Flight) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Flight(ctx, sel, v)
