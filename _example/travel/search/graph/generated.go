...
type ComplexityRoot struct {
	...
	Query struct {
		SearchTravel       func(childComplexity int, from string, to string) int
...
type QueryResolver interface {
	SearchTravel(ctx context.Context, from string, to string) ([]model.TravelOption, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.searchTravel":
		if e.complexity.Query.SearchTravel == nil {
			break
		}

		args, err := ec.field_Query_searchTravel_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchTravel(childComplexity, args["from"].(string), args["to"].(string)), true
	case "Query._service":
...
func (ec *executionContext) field_Query_searchTravel_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) _Query_searchTravel(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_Query_searchTravel,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Query().SearchTravel(ctx, fc.Args["from"].(string), fc.Args["to"].(string))
		},
		nil,
		ec.marshalNTravelOption2ᚕgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋsearchᚋgraphᚋmodelᚐTravelOptionᚄ,
		true,
		true,
	)
}

func (ec *executionContext) fieldContext_Query_searchTravel(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return nil, errors.New("field of type TravelOption does not have child fields")
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	if fc.Args, err = ec.field_Query_searchTravel_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _TravelOption(ctx context.Context, sel ast.SelectionSet, obj model.TravelOption) graphql.Marshaler {
	switch obj := (obj).(type) {
	case nil:
		return graphql.Null
	case model.Hotel:
	...
	default:
		if typedObj, ok := obj.(graphql.Marshaler); ok {
			...
			panic(fmt.Errorf("unexpected type %T; non-generated variants of TravelOption must implement graphql.Marshaler", obj))
		}
	}
}
...
var flightImplementors = []string{"Flight", "TravelOption", "_Entity"}
...
var hotelImplementors = []string{"Hotel", "TravelOption", "_Entity"}
	...
	for i, field := range fields {
		...
		case "searchTravel":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchTravel(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) marshalNTravelOption2githubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋsearchᚋgraphᚋmodelᚐTravelOption(ctx context.Context, sel ast.SelectionSet, v model.TravelOption) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
	...
	return ec._TravelOption(ctx, sel, v)
}

func (ec *executionContext) marshalNTravelOption2ᚕgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋsearchᚋgraphᚋmodelᚐTravelOptionᚄ(ctx context.Context, sel ast.SelectionSet, v []model.TravelOption) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTravelOption2githubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋtravelᚋsearchᚋgraphᚋmodelᚐTravelOption(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
