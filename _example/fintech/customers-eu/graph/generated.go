...
import (
	...
	"github.com/n9te9/go-graphql-federation-gateway/_example/fintech/customers-eu/graph/model"
...
type ComplexityRoot struct {
	Customer struct {
		GdprConsent func(childComplexity int) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Customer.gdprConsent":
		if e.complexity.Customer.GdprConsent == nil {
			break
		}

		return e.complexity.Customer.GdprConsent(childComplexity), true
	case "Customer.id":
...
func (ec *executionContext) _Customer_gdprConsent(ctx context.Context, field graphql.CollectedField, obj *model.Customer) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		ec.fieldContext_Customer_gdprConsent,
		func(ctx context.Context) (any, error) {
			return obj.GdprConsent, nil
		},
		nil,
...
func (ec *executionContext) fieldContext_Customer_gdprConsent(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Customer",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Entity_findCustomerByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNCustomer2ᚖgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋfintechᚋcustomersᚑeuᚋgraphᚋmodelᚐCustomer,
		true,
		true,
	)
}
...
func (ec *executionContext) fieldContext_Entity_findCustomerByID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "gdprConsent":
				return ec.fieldContext_Customer_gdprConsent(ctx, field)
			}
...
func (ec *executionContext) _Customer(ctx context.Context, sel ast.SelectionSet, obj *model.Customer) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "gdprConsent":
			out.Values[i] = ec._Customer_gdprConsent(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNCustomer2githubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋfintechᚋcustomersᚑeuᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v model.Customer) graphql.Marshaler {
	return ec._Customer(ctx, sel, &v)
}

func (ec *executionContext) marshalNCustomer2ᚖgithubᚗcomᚋn9te9ᚋgoᚑgraphqlᚑfederationᚑgatewayᚋ_exampleᚋfintechᚋcustomersᚑeuᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v *model.Customer) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
